...
function Registartion({ onAddData ,isModalOpen,closeModal ,modalMessage}) {
  ...
  return (
    <>
      <div className="game-header-text game-header"> <h1>Create Account</h1></div>
      <div className="game-logout">

        {/* <div className="logout-form" >
          <button onClick={onLogout} className="game-logoutbutton" type="button">LogIn</button>
        </div> */}
      </div>
