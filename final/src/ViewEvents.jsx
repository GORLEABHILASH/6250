...
function ViewEvents({ onLogout, view, isDataPending, onRegister, isModalOpen, onHome ,closeModal,modalMessage}) {
                ...
                <>
                    ...
                    <CentreRectangle className='viewevents-center-rectangle' >
                        ...
                        <div className='viewevents-container'>
                            ...
                            <button className="event-register-button" type="submit"  onClick={() => handleRegister(view.id)}>Register</button>
